...
class Music(models.Model):
    ...
    alternative_title_1 = models.CharField(max_length=200, help_text="Alternative Title 1")
    alternative_title_2 = models.CharField(max_length=200, help_text="Alternative Title 2")
    alternative_title_3 = models.CharField(max_length=200, help_text="Alternative Title 3")
